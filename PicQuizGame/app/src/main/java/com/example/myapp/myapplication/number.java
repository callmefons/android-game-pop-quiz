...
public class number extends ListFragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        TypedArray values_imgs = getResources().obtainTypedArray(R.array.numberimgs);
        ...
        String[] values_description = getResources().getStringArray(R.array.numberdescrition);
        String[] values_description_2 = getResources().getStringArray(R.array.numberdescrition2);
