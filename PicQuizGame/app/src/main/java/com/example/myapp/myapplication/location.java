 ...
 */
public class location extends ListFragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        TypedArray values_imgs = getResources().obtainTypedArray(R.array.locationimgs);
        ...
        String[] values = getResources().getStringArray(R.array.location);
        String[] values_description = getResources().getStringArray(R.array.locationdescrition);
        String[] values_description_2 = getResources().getStringArray(R.array.locationdescrition2);
