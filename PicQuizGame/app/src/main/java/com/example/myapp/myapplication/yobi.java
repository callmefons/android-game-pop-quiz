 ...
 */
public class yobi extends ListFragment {

    Activity mActivity;
    private CustomArrayAdapter myCustomArrayAdapter;

    public static yobi newInstance() {
        yobi fragment = new yobi();
        return fragment;
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        TypedArray values_imgs = getResources().obtainTypedArray(R.array.yobiimgs);
        ...
        String[] values = getResources().getStringArray(R.array.yobi);
        String[] values_description = getResources().getStringArray(R.array.yobidescrition);
        String[] values_description_2 = getResources().getStringArray(R.array.yobidescrition2);
